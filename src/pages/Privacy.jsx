  ...
  return (
    ...
    >
      ...
      <div style={{ lineHeight: '1.8', color: 'var(--text-secondary)' }}>
        ...
        <p>At ThumbDown, we do not require you to create an account, and we do not collect personal identifiable information (PII) such as your name, address, or phone number simply for using our core downloader tool. All URL processing is done transparently.</p>
