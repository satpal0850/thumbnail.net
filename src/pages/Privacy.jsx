...
const Privacy = () => {
  return (
    <>
    <Helmet>
      <title>Privacy Policy | KlickThumb</title>
      <meta name="description" content="Privacy Policy for KlickThumb, a free youtube thumbnail downloader." />
    ...
    >
      ...
      <div style={{ lineHeight: '1.8', color: 'var(--text-secondary)' }}>
        ...
        <p>At KlickThumb, we do not require you to create an account, and we do not collect personal identifiable information (PII) such as your name, address, or phone number simply for using our core downloader tool. All URL processing is done transparently.</p>
